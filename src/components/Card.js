            ...
            <div className="col mb-5 mt-4">
                <div className="card" style={{width: '20rem', textAlign: 'center'}}>
                    ...
                    <div className="card-body">
                        ...
                        <span className='badge bg-secondary'>{this.props.card.quantity}</span>
                    </div>

                    <button className="btn btn-primary" onClick={() => this.props.onIncrement(this.props.card)}>Add</button>
